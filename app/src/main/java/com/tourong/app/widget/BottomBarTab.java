package com.tourong.app.widget;
...
public class BottomBarTab extends FrameLayout {
    ...
    public BottomBarTab(Context context, @DrawableRes int icon, @DrawableRes int iconCheck, CharSequence title) {
        this(context, null, icon, iconCheck, title);
    }

    public BottomBarTab(Context context, AttributeSet attrs, int icon, int iconCheck, CharSequence title) {
        this(context, attrs, 0, icon, iconCheck, title);
    }

    public BottomBarTab(Context context, AttributeSet attrs, int defStyleAttr, int icon, int iconCheck, CharSequence title) {
        super(context, attrs, defStyleAttr);
        init(context, icon, iconCheck, title);
    }

    private void init(Context context, int icon, int iconCheck, CharSequence title) {
        mContext = context;
        ...
        mTvUnreadCount.setBackgroundResource(R.drawable.bg_bubble_msg);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mIcon.setImageResource(iconCheck);
